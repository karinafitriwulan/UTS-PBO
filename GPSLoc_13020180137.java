public class GPSLoc_13020180137 {
	String nama, deskripsi;
	int longitude, latitude, baruLat, baruLong;

	public GPSLoc_13020180137(){
		longitude = 55;
		latitude = 90;
	}

	public GPSLoc_13020180137(String namabaru, String deskripsibaru){
		nama = namabaru;
		deskripsi = deskripsibaru;
	}
	
	void moveTo(int dLat, int dLong){
		GPSLoc_13020180137 g = new GPSLoc_13020180137();
